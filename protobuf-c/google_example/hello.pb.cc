...
void protobuf_AssignDesc_hello_2eproto() {
  ...
  static const int helloworld_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(helloworld, dd2_),
  };
...
const int helloworld::kDd2FieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_dd2;
        break;
      }
...
void helloworld::SerializeWithCachedSizes(
  ...
  // required int32 dd2 = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->dd2(), output);
  }
...
::google::protobuf::uint8* helloworld::SerializeWithCachedSizesToArray(
  ...
  // required int32 dd2 = 2;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->dd2(), target);
  }
