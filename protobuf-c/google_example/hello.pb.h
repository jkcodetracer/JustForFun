...
class helloworld : public ::google::protobuf::Message {
 public:
  ...
  // required int32 dd2 = 2;
  inline bool has_dd2() const;
  inline void clear_dd2();
  static const int kDd2FieldNumber = 2;
  inline ::google::protobuf::int32 dd2() const;
  inline void set_dd2(::google::protobuf::int32 value);
...
// required int32 dd2 = 2;
inline bool helloworld::has_dd2() const {
  return _has_bit(1);
}
inline void helloworld::clear_dd2() {
  dd2_ = 0;
  _clear_bit(1);
}
inline ::google::protobuf::int32 helloworld::dd2() const {
  return dd2_;
}
inline void helloworld::set_dd2(::google::protobuf::int32 value) {
  _set_bit(1);
  dd2_ = value;
}
