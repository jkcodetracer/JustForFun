...
void
ptrace_write (pid_t pid, unsigned long addr, void *vptr, int len)
{
  int count;
  long word;
...
void
ptrace_read (pid_t pid, unsigned long addr, void *vptr, int len)
{
  int i, count;
  long word;
...
char *
ptrace_readstr (pid_t pid, unsigned long addr)
{
...
void
ptrace_readreg (pid_t pid, struct user_regs_struct *regs)
{
...
void
ptrace_writereg (pid_t pid, struct user_regs_struct *regs)
{
...
void *
ptrace_push (pid_t pid, void *paddr, int size)
{
  unsigned long esp;
...
void
ptrace_call (pid_t pid, unsigned long addr)
{
  void *pc;
  struct user_regs_struct regs;
  int stat;
...
void
ptrace_call_special (pid_t pid, unsigned long addr)
{
  void *pc;
  struct user_regs_struct regs;
  int stat;
...
void
ptrace_attach_special (pid_t pid)
{
  void *pc;
  void *pra;
